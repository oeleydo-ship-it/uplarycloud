<x-marketing-layout :page="$page">
    <div class="mkt-wrap mkt-page">
        ...
        <div class="mkt-prose" style="margin-top:28px">
            ...
            <p>Clarity over ceremony. The console should tell you what is running and what to do next — connect a server, deploy an app, attach a domain. Plan gates exist so a personal experiment and a production team are not forced into the same bill.</p>
            <h2>Who it is for</h2>
            <p>Independent developers who want a grown-up ops picture on one VPS. Agencies that repeat the same client stack. Product teams that need roles, tokens, and an audit trail without assembling a private PaaS.</p>
